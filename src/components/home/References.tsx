...
const references = [
  {
    ...
    title: "Research Co-author & Colleague",
    ...
    testimonial:
      "Collaborated with Tanjid on our IEEE research paper about CycleGAN performance. His technical depth and dedication to machine learning research were impressive.",
    projects: "IEEE Conference Paper - NCIM 2025",
    strengths: [
      "Research Skills",
      "Machine Learning",
      "Technical Writing",
  ...
  },
  {
    ...
    location: "Dhaka, Bangladesh",
    testimonial:
      "As Vice President, Tanjid demonstrated strong leadership and technical mentorship. He guided students in programming and organized successful technical events.",
    projects: "NUBCC App, Programming Workshops",
    strengths: [
      "Leadership",
      "Mentorship",
      "Technical Guidance",
  ...
  },
  {
    ...
    testimonial:
      "Tanjid significantly improved our EdTech app with user-requested features and better code architecture. His work enhanced the learning experience for thousands of students.",
    projects: "Softmax Online School App",
    strengths: [
      "Flutter Development",
      "Code Refactoring",
      "User Experience",
